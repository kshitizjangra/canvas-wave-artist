  ...
  return (
    ...
    >
      <svg
        ...
        strokeWidth="1"
        viewBox="0 0 16 16"
        className="h-6 w-6 -translate-x-[12px] -translate-y-[10px] -rotate-[70deg] transform stroke-blue-600 text-blue-500"
        height="1em"
        width="1em"
      ...
      <div className="w-fit rounded-full bg-blue-500 px-2 py-1 text-white">
        {name || "Guest"}
      </div>
    </motion.div>
  )
